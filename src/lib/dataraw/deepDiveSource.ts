...
async function fetchRowsPaged(importIds: string[]): Promise<Map<string, Record<string, unknown>[]>> {
...
function readShopDays(columns: DataRawColumn[], rows: Record<string, unknown>[], start: string, end: string): ShopDayRow[] {
  const c = {
