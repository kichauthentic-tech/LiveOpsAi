...
export const PerformanceMetricsWidget: React.FC<PerformanceMetricsWidgetProps> = ({
  ...
  return (
    <div className="bg-slate-900/95 border border-purple-500/30 rounded-3xl p-6 shadow-2xl space-y-5 relative overflow-hidden backdrop-blur-md">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 lg:grid-cols-5 gap-3">
        ...
        <div className="bg-slate-950/80 p-4 rounded-2xl border border-emerald-500/30 hover:border-emerald-500/60 transition-all group relative overflow-hidden">
          ...
          <div className="mt-2 space-y-1 border-t border-slate-900 pt-1.5">
            <div className="flex justify-between text-[10px]">
              <span className="text-slate-400">Target GMV:</span>
              <span className="text-slate-200 font-bold">{formatCurrency(totalTargetGmv)}</span>
            </div>
            ...
            <div className="flex justify-between text-[9px] font-bold">
              <span className="text-slate-400">Tiến độ KPI:</span>
        ...
        <div className="bg-slate-950/80 p-4 rounded-2xl border border-red-500/30 hover:border-red-500/60 transition-all group relative overflow-hidden">
          <div className="flex items-center justify-between mb-2">
          ...
          <div className="flex items-baseline gap-2">
            <span className="text-2xl font-black text-white">{liveNowCount}</span>
            <span className="text-[11px] text-red-400 font-bold">/ {totalSessionsCount} tổng phiên</span>
          </div>
          <div className="mt-2 text-[10px] text-slate-400 space-y-1 border-t border-slate-900 pt-1.5">
        ...
        <div className="bg-slate-950/80 p-4 rounded-2xl border border-purple-500/30 hover:border-purple-500/60 transition-all group relative overflow-hidden">
          <div className="flex items-center justify-between mb-2">
          ...
          <div className="mt-2 text-[10px] text-slate-400 space-y-1 border-t border-slate-900 pt-1.5">
            ...
            <div className="flex justify-between">
              ...
              <strong className="text-slate-200">{totalViews.toLocaleString("vi-VN")}</strong>
            </div>
          </div>
        </div>

        {/* Metric 4: Total Orders (Tổng Đơn Hàng) */}
        <div className="bg-slate-950/80 p-4 rounded-2xl border border-blue-500/30 hover:border-blue-500/60 transition-all group relative overflow-hidden">
          <div className="flex items-center justify-between mb-2">
          ...
          <div className="mt-2 text-[10px] text-slate-400 border-t border-slate-900 pt-1.5 flex items-center justify-between">
        ...
        <div className="bg-slate-950/80 p-4 rounded-2xl border border-amber-500/30 hover:border-amber-500/60 transition-all group relative overflow-hidden">
          <div className="flex items-center justify-between mb-2">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="text-[10px] text-slate-400 uppercase font-bold">CVR</div>
      ...
      {liveNowSessions.length > 0 && (
        <div className="bg-slate-950/70 rounded-2xl p-3.5 border border-red-500/20 flex flex-wrap items-center justify-between gap-3 text-xs">
          <div className="flex items-center gap-3 min-w-[260px] grow md:grow-0">
            ...
            <div>
              <span className="text-slate-400 text-[11px] font-medium">Phiên Phát Sóng Nổi Bật:</span>
              <h4 className="font-bold text-white text-xs truncate max-w-sm">
