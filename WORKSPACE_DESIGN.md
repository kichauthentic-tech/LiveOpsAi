...
> **Trạng thái: GIAI ĐOẠN A + B1-B6 + C1-C3 ĐÃ CODE + VERIFY XONG.** Roadmap "6 module mới" gốc ở mục 6 đã hoàn thành. Giai đoạn C (4 module mới, mục 6.1) đã xong **C1 — Onboarding Checklist theo Brand**, **C2 — GMV Target vs Actual theo Calendar**, **C3 — Scheme khuyến mãi tích hợp Calendar**; còn 1 module C (Price List Import) chưa code, chờ user chọn thời điểm làm ở phiên sau.
