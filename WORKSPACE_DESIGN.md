...
**Trạng thái dữ liệu thật (2026-09-19):** CROCS tháng 6/2026 đã nạp — 63 ca backfill (62 room, 1 room tách đôi), **chưa gán host** vì CROCS chưa có hồ sơ talent thật (Talent A/B/C/D là mẫu). Tháng 4,5,7,8,9 CROCS và 3 brand còn lại: user tự up bằng file tách sẵn trong `~/Downloads`.
