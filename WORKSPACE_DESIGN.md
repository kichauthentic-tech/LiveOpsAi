...
**Trạng thái dữ liệu (2026-09-19):** 153 ca `open` còn lại đều từ thời demo (T8: 4 brand × 31; T9: JOCKEY 29; tạo 11–20/08, không ai đăng ký) + 4 quy tắc "Hàng Ngày" demo. Script dọn sẵn: `supabase/seed/2026-09_clear_demo_slots.sql` — **chưa chạy, user quyết**. Chưa bấm "Mở ca" trên DB thật (xem trước cho tháng 9 ra 36 ca từ quy tắc demo — không sinh vì không phải lịch thật).
