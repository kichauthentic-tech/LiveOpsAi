...
**Trạng thái dữ liệu thật (2026-09-19, sau khi dọn mock bằng `2026-09_clear_all_mock.sql`):** DB thật KHÔNG còn mock — 0 seed session/slot/plan, 0 đăng ký rảnh, talent mẫu đã xoá. Có: 35 hồ sơ talent thật, 63 ca backfill CROCS tháng 6 (host trống — user tự gán bằng lưới), 29 slot JOCKEY tháng 9 do ops tạo, tài khoản `kichauthentic@gmail.com` role talent chưa gắn hồ sơ. Tháng 4,5,7,8,9 CROCS và 3 brand còn lại: user tự up bằng file tách sẵn trong `~/Downloads`. Tuần chạy thử giờ chạy trên dữ liệu thật, không seed lại.
